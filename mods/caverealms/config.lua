...
setting("number", "ymax", -1000) --top realm limit
...
setting("number", "dm_top", -7000) --upper limit 
setting("number", "dm_bot", -9000) --lower limit 
--should fortresses and fountains spawn?
setting("bool", "fortresses", true)
setting("bool", "fountains", true)
--Deep cave settings
setting("number", "deep_cave", -10000) -- upper limit
