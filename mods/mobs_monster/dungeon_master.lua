...
mobs:register_mob("mobs_monster:dungeon_master", {
	...
	sounds = {
		random = "mobs_dungeonmaster_neutral",
		damage = "mobs_dungeonmaster_hit",
		attack = "mobs_dungeonmaster_attack",
		death = "mobs_dungeonmaster_death",
		shoot_attack = "mobs_dungeonmaster_spell",
		distance = 15
	},
	walk_velocity = 1,
	run_velocity = 3,
	...
	drops = {
		...
		{name = "farming_addons:seed_coffee", chance = 4, min = 1, max = 3},
		{name = "farming_addons:seed_corn", chance = 4, min = 1, max = 3},
		{name = "farming_addons:seed_melon", chance = 4, min = 1, max = 3},
		{name = "default:diamond", chance = 2, min = 1, max = 1},
		{name = "default:mese_crystal", chance = 2, min = 1, max = 2},
		{name = "default:diamondblock", chance = 10, min = 1, max = 1},
	},
	water_damage = 10,
	lava_damage = 10,
	light_damage = 0,
...
mobs:spawn({
	name = "mobs_monster:dungeon_master",
	nodes = {"default:stone", "caverealms:hot_cobble","default:stonebrick"},
	chance = 900,
	active_object_count = 1,
	min_height = -9000,
	max_height = -7000,
