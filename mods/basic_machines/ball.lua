...
local ball_spawner_update_form = function (pos)
		...
		local texture = meta:get_string("texture") or  "basic_machines_ball_bullet.png";
...
minetest.register_entity("basic_machines:ball",{
	...
	on_activate = function(self, staticdata)
		self.object:set_properties({textures={"basic_machines_ball_bullet.png"}})
...
minetest.register_node("basic_machines:ball_spawner", {
	...
	after_place_node = function(pos, placer)
		...
		meta:set_string("texture", "basic_machines_ball_bullet.png");
...
minetest.register_tool("basic_machines:ball_spell", {
	...
	inventory_image = "basic_machines_ball_bullet.png",
	tool_capabilities = {
