...
minetest.register_node("basic_machines:battery_0", {
	...
	tiles = {"basic_machine_outlet.png","basic_machine_battery_bottom.png","basic_machine_battery_0.png"},
	...
	mesecons = {effector = {
		...
		allow_metadata_inventory_put = function(pos, listname, index, stack, player)
			...
			if minetest.is_protected(pos, player:get_player_name()) and not privs.privs then
