...
armor:register_armor("3d_armor:helmet_magma", {
	description = "Enchanted Magmat Helmet"..minetest.colorize("#00baff", "\nExtra durable")..minetest.colorize("#ff3d3d", "\nExtra healing"),
	inventory_image = "3d_armor_inv_helmet_magma.png",
	preview = "3d_armor_helmet_magma_preview.png",
	groups = {armor_head=1, armor_heal=12, armor_use=100},
	armor_groups = {fleshy=15},
	damage_groups = {cracky=2, snappy=1, level=3},
})
armor:register_armor("3d_armor:chestplate_magma", {
	description = "Enchanted Magma Chestplate"..minetest.colorize("#00baff", "\nExtra durable")..minetest.colorize("#ff3d3d", "\nExtra healing"),
	inventory_image = "3d_armor_inv_chestplate_magma.png",
	preview = "3d_armor_chestplate_magma_preview.png",
	groups = {armor_torso=1, armor_heal=12, armor_use=100},
	armor_groups = {fleshy=20},
	damage_groups = {cracky=2, snappy=1, level=3},
})
armor:register_armor("3d_armor:leggings_magma", {
	description = "Enchanted Magma Leggings"..minetest.colorize("#00baff", "\nExtra durable")..minetest.colorize("#ff3d3d", "\nExtra healing"),
	inventory_image = "3d_armor_inv_leggings_magma.png",
	preview = "3d_armor_leggings_magma_preview.png",
	groups = {armor_legs=1, armor_heal=12, armor_use=100},
	armor_groups = {fleshy=20},
	damage_groups = {cracky=2, snappy=1, level=3},
})
armor:register_armor("3d_armor:boots_magma", {
	description = "Enchanted Magma Boots"..minetest.colorize("#fd5eff", "\nExtra fast and jump")..minetest.colorize("#ff3d3d", "\nExtra healing"),
	inventory_image = "3d_armor_inv_boots_magma.png",
	preview = "3d_armor_boots_magma_preview.png",
	groups = {armor_feet=1, armor_heal=12, armor_use=100, physics_speed=1,
			physics_jump=0.5},
	armor_groups = {fleshy=15},
	damage_groups = {cracky=2, snappy=1, level=3},
